...
3. **我的在途订单**  
   ...
   <div align="center"><img src="./img/我的在途订单的订单详情1.png" alt="订单详情页面" width="40%"></div>  
   \begin{center}
      \includegraphics[width=0.4\textwidth]{./img/我的在途订单的订单详情1.png}
   \end{center}  

    <div align="center"><img src="./img/我的在途订单的订单详情2.png" alt="订单详情页面" width="40%"></div>  
   \begin{center}
      \includegraphics[width=0.4\textwidth]{./img/我的在途订单的订单详情2.png}
   \end{center}  
...
3. **功能操作**   
   ...
   \begin{center}
      \includegraphics[width=0.4\textwidth]{./img/修改手机号.jpeg}
   \end{center}
...
1. **订单详情页面**   
   ...
   \begin{center}
      \includegraphics[width=0.4\textwidth]{./img/订单详情.jpeg}
   \end{center}
